...
function addTodo() {
  ...
  const timeYear = document.getElementById('year').value;

  const generatedID = generateId();
  const todoObject = generateTodoObject(generatedID, textTodo, textAuthor, timeYear, false);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  submitForm.addEventListener('submit', function (event) {
    ...
    const timeYear = document.getElementById('year');
